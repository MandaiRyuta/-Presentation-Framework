...
//
//
//class CEffekseer : public GameObjectManager
//{
//public:
//	struct Transform
//	{
...
//
//public:
//	CEffekseer(Effect EffectType, int prioriy) : GameObjectManager(prioriy)
//	{
//		//描画管理用インスタンスの生成
//		effekseerRenderer_ = EffekseerRendererDX9::Renderer::Create(GetDevice(), 2000);
//		// エフェクト管理用インスタンスの生成
