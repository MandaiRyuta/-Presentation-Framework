...
Entity::EffectSoundParameter EffectSound::InitEffectSound()
{
	Entity::EffectSoundParameter Effectinfo;
...
HRESULT EffectSound::SetEffectSound(SOUND_LABEL label, Entity::EffectSoundParameter Effectinfo)
{
	HRESULT hr;
