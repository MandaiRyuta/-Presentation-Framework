...
////================================================================================
//
//void Timer::DrawTimer(int nTime, int dig, bool bZero, float x, float y, int ver)
//{
//	if (ver == 1)
//	{
//		// 左詰め対応( こっちのが早い )
...
////================================================================================
//
//void Timer::DrawNumber(int n, float x, float y)
//{
//	if (n < 0 || n > 9)
//	{
//		return;
...
//}
//
//void Timer::DrawNumberScore(int n, float x, float y)
//{
//	if (n < 0 || n > 9)
//	{
//		return;
...
//	}
//}
//void Timer::DrawPolygon(TEXTURENUM texNum, D3DCOLOR color, float dx, float dy, float dw, float dh, int tcx, int tcy, int tcw, int tch, bool bAffine)
//{
//	LPDIRECT3DDEVICE9 pDevice = GetDevice();
//
...
//}
//
//void Timer::CreateVertex(int texNum, D3DCOLOR color, float dx, float dy, float dw, float dh, int tcx, int tcy, int tcw, int tch)
//{
//	VERTEX_2D* pV;
...
//}
//
//void Timer::CreateVertexAffine(int texNum, D3DCOLOR color, float dx, float dy, float dw, float dh, int tcx, int tcy, int tcw, int tch)
//{
//	VERTEX_2D* pV;
//	g_pVertexBuffer->Lock(0, 0, (void**)&pV, D3DLOCK_DISCARD);
//
...
//
//}
//void Timer::SetPolygonRotation(float cx, float cy, float fangle)
//{
...
//}
//
//void Timer::SetPolygonScale(float scaleX, float scaleY)
//{
//	g_fScaleX = scaleX;
//	g_fScaleY = scaleY;
//}
//
//Timer * Timer::Create(int Priority)
//{
//	Timer* CreateNumber = new Timer(Priority);
