...
//	GameManager::GetModel("Tree")->GetModelData()->p_mesh->GetVertexBuffer(&buffer_.vertex_buffer);
//	GameManager::GetModel("Tree")->GetModelData()->p_mesh->GetIndexBuffer(&buffer_.index_buffer);
//
...
//
//	pDevice->SetStreamSource(0, buffer_.vertex_buffer, 0, GameManager::GetModel("Tree")->GetModelData()->p_mesh->GetNumBytesPerVertex());
...
//		D3DXVECTOR4 color = { 255,255,255,255 };
...
//		for (DWORD i = 0; i < GameManager::GetModel("Tree")->GetModelData()->dw_material; i++)
//		{
//			//pDevice->SetTexture(0, this->model_->p_meshtexture_[i]);
//			EffectShaderManager::GetEffect(INSTANCING3D)->SetTexture("texDecal", GameManager::GetModel("Tree")->GetModelData()->p_meshtexture[i]);
//			GameManager::GetModel("Tree")->GetModelData()->p_mesh->DrawSubset(i);
