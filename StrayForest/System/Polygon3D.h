...
class CScene3D : public GameObjectManager
{
private:
	typedef enum
	{
...
public:
	CScene3D(int Priority, std::string filename, D3DXVECTOR3 pos, D3DXVECTOR3 scall, float rotation) : filename_(filename), GameObjectManager(Priority)
	{
		this->position_ = pos;
		this->scall_ = scall;
